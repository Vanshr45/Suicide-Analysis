...
```
INT387-Suicide-Analysis/
├── Dataset/
│   ├── Cleaned Data/
│   │   ├── suicides-by-causes.xlsx
│   │   ├── suicides-by-economic-status.xlsx
│   │   ├── suicides-by-educational-status.xlsx
│   │   ├── suicides-by-marital-status.xlsx
│   │   └── suicides-by-profession-wise.xlsx
│   └── Raw Data/
│       ├── suicides-by-causes.csv
│       ├── suicides-by-economic-status.csv
│       ├── suicides-by-educational-status.csv
│       ├── suicides-by-marital-status.csv
│       └── suicides-by-profession-wise.csv
├── Suicide Analysis Project.pbix
